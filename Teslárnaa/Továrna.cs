...
namespace Teslárnaa
{
    internal class Továrna
    {
        ...
        public string Menu()
        {
            Console.WriteLine("Vítejte v továrně na Tesly");
            Console.WriteLine("Nabízíme tyto modely:");
        ...
        public Auto VytvorAuto()
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("Jsi kár a neumíš psát, zkus to znovu.");

            }
            #endregion druhpohonu
            Console.WriteLine("Zadejte Cenu:  pro použití desetinného čísla, zadej čárku");
